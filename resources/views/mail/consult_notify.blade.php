...
<div id="wrapper" style="background-color: #f0f6fb;">
    ...
    <div class="" style="padding-top: 50px !important; padding: 0;">
        <h1 style="margin: 3%; margin-top: 50px !important;">Consultation Notification</h1>

        <p style="margin: 3%; color: black;">
            Just a quick heads-up - we've got a new consultation request on the website.
