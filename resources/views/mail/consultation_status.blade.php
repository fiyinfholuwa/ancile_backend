...
<div id="wrapper" style="background-color: #f0f6fb;">
    ...
    <div class="" style="padding-top: 100px !important;">
        ...
        <p style="margin: 3%; color: black;">I hope this message finds you well. I wanted to inform you that your consultation application status has changed to <span style="font-weight: bolder">{{$mailData['status']}}</span> We appreciate your patience and will update you with the final decision soon.
        </p>
