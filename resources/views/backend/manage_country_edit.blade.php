        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="{{route('manage.country.update', $country->id)}}"  enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-md-12">
                  <label for="inputName5" class="form-label">Country Name</label>
                  <input type="text" name="name" value="{{$country->name}}" class="form-control" placeholder="Enter Country Name" id="inputName5">
                ...
                <div class="col-md-12">
                  ...
                  @enderror
                    ...
                    <div style="margin: 20px 0px;">
                        <img height="40px" width="40px" src="{{asset($country->flag)}}">
                    </div>
                </div>
