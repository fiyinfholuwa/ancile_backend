              ...
              <form class="row g-3" method="post" action="{{route('admin.application.update', $app->id)}}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="email" name="email" value="{{$app->email}}" placeholder="Email" class="form-control" id="inputEmail5">
                      <p style="font-weight:bold; color:red; font-size:12px;">
                          @error('email')
                          {{$message}}
                          @enderror
                  ...
                  <div class="col-md-6">
                      ...
                      <select name="course" id="course" class="form-control">
                          ...
                          @foreach($course_cat as $course)
                              <option value="{{$course->name}}" {{$course->name == $app->course ? "selected": ""}}>{{$course->name}}</option>
                          @endforeach
                      </select>
                      <p style="color: red; font-weight: 500">
                          @error('course')
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="text" name="address" value="{{$app->country}}" placeholder="Address" class="form-control"/>
                      <p style="color: red; font-weight: 500">
                          @error('address')
                          {{$message}}
                          @enderror
                  ...
                  <div class="col-md-6">
                      ...
                      <select name="year"  id="year" class="form-control">
                          <option value="{{$app->year}}">{{$app->year}}</option>
                  ...
                  <div class="first-input col-lg-6">
                      ...
                      <select class="form-control" name="application_status" id="year">
                          <option value="{{$app->application_status}}">{{$app->application_status}}</option>
                  ...
                  <div class="first-input col-lg-6">
                      ...
                      <input type="text" class="form-control" value="{{$app->shortlist}}" name="shortlist" placeholder="Type short listed Universities"/>
                      <p style="color: red; font-weight: 500">
                          @error('shortlist')
                          {{$message}}
                          @enderror
                      ...
                      <div class="personals">
                          <div>
                              ...
                              <div class="file-input">
                                  <select class="form-control" name="gre_option[]">
