...
<head>
    <title>Ancileacademy - Dashboard</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="{{asset('/backend/assets/images/favicon.svg')}}" type="image/x-icon"> <!-- [Font] Family -->
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha384-KyZXEAg3QhqLMpG8r+8fhAXLR4zYJ5iENBO06fYlB8kEzZ55niPy5XKpQ+cl4zp2" crossorigin="anonymous"></script>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="{{asset('backend/assets/images/user/avatar-1.jpg')}}" alt="user-image" class="user-avtar wid-45 rounded-circle" />
                        </div>
...
{{--                        <span class="pc-badge">2</span>--}}
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{ route('application.view') }}">Add Application</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{ route('application.all') }}">All Applications</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{route('consultation.all')}}">Consultations</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{route('admin.english.view')}}">English Test</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{route('admin.academy.view')}}">Academy Tutorials</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{route('admin.apply.course.all')}}">Applied Courses</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{route('admin.loan.all')}}">Loan Application</a></li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext">Testimonial</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span
                        ></a>
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="{{route('admin.testimonial.view')}}">Add Testimonial</a></li>
                        <li class="pc-item"><a class="pc-link" href="{{route('admin.testimonial.all')}}">All Testimonials</a></li>
                    </ul>
                </li>
