    ...
    @else
        <div class="second-nav">
            ...
            <div class="nav-profile">
                <i class="fa-solid fa-xmark iconn"></i>
                <div class="search-box">
                    <i style="font-weight: lighter;" class="fa-solid fa-magnifying-glass"></i>
                    <div class="input-box">
                        <form action="{{route('faq.general.search')}}" method="get">
                            <input type="text" name="search" placeholder="Search...">
...
<section>
    ...
    <div class="msg-container track-contain">
        <div class="msg-text track-tracking">
            <h4 class="id-head">Application ID: {{$application->app_uid}}</h4>
            <ul class="track">
        ...
        @if($application->assigned_id == null)
            <div class="track-profile">
                ...
                <img src="{{asset('https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI=')}}" alt="" class="user-img">
                <h3>Not Assigned Yet</h3>
            </div>
        @else
            <div class="track-profile">
                <h4>Counsellor Assigned</h4>
                <img src="{{optional($application->counsellor_name)->image != NULL ? asset(optional($application->counsellor_name)->image) : asset('https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI=')}}" alt="" class="user-img">
                <h3>{{optional($application->counsellor_name)->first_name}}  {{optional($application->counsellor_name)->last_name}}</h3>
                                    <p>{{optional($application->counsellor_name)->address}}</p>
