              ...
              <div class="modal" id="user_delete_{{$user->id}}" tabindex="-1">
                <form method="post" action="{{route('admin.counsellor.delete', $user->id)}}">
                  @csrf
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 style="font-weight:bold;" class="modal-title text-primary">Counsellor Delete</h5>
              ...
              <div class="modal" id="user_block_{{$user->id}}" tabindex="-1">
                <form method="post" action="{{route('admin.counsellor.block', $user->id)}}">
                  @csrf
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 style="font-weight:bold;" class="modal-title text-primary">Counsellor Block</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    <div class=" mb-3">
