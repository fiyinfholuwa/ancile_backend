...
<head>
    <title>Ancileacademy Counsellor - Dashboard</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
...
<nav class="pc-sidebar">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{route('counsellor.dashboard')}}" class="b-brand text-primary">
        ...
        <div class="navbar-content">
            <div class="card pc-user-card">
                <div class="card-body">
                    ...
                    <div class="collapse pc-user-links" id="pc_sidebar_userlink">
                        <div class="pt-3">
                            <a href="{{route('counsellor.profile.view')}}">
            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="{{route('counsellor.dashboard')}}" class="pc-link">
            <span class="pc-micon">
              <svg class="ph-duotone ph-user-list ph-user-list">
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="{{route('counsellor.application.assigned')}}" class="pc-link">
                        <i style="font-size: 20px;" class="ph-duotone ph-user-list"></i>
                        <span class="pc-mtext">Assigned Applications</span>
                        {{--                        <span class="pc-arrow"><i data-feather="chevron-right"></i></span>--}}
                        {{--                        <span class="pc-badge">2</span>--}}
                    </a>
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="{{route('counsellor.profile.view')}}" class="pc-link">
            ...
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                        <a href="{{route('counsellor.profile.view')}}" class="dropdown-item">
                            <i class="ti ti-user"></i>
                            <span>My Account</span>
                        </a>
                ...
                <li class="dropdown pc-h-item">
                    ...
                    >
                        ...
                        <span class="badge bg-success pc-h-badge">{{count($unread_messages)}}</span>
                    </a>
        ...
        <div class="page-header">
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('counsellor.dashboard')}}">Home</a></li>
